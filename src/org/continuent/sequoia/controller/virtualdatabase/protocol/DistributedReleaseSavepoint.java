 ...
 * @version 1.0
 */
public class DistributedReleaseSavepoint extends DistributedTransactionMarker
{
   ...
   */
  public DistributedReleaseSavepoint(long transactionId, String savepointName)
  {
    super(transactionId);
      ...
      throws SQLException
  {
    ...
    {
      addFailureOnAllBackends(drm, hasBeenScheduled, tm);
      if (drm.getLogger().isDebugEnabled())
        drm.getLogger().debug(
            Translate.get(
  ...
  private void addFailureOnAllBackends(DistributedRequestManager drm,
      boolean hasBeenScheduled, TransactionMetaData tm)
  {
    AbstractRequest request = new UnknownWriteRequest("release "
  ...
  {
    if (super.equals(obj))
      return savepointName.equals(((DistributedReleaseSavepoint) obj)
          .getSavepointName());
    else
      return false;
  }
