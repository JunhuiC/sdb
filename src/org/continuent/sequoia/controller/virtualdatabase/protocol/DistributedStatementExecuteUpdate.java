...
/**
 * Execute a distributed call to Statement.executeUpdate() between several
 * controllers.
 * 
 * @author <a href="mailto:Emmanuel.Cecchet@inria.fr">Emmanuel Cecchet </a>
 * @version 1.0
 */
public class DistributedStatementExecuteUpdate extends DistributedRequest
{
   ...
   */
  public DistributedStatementExecuteUpdate(AbstractWriteRequest request)
  {
    super(request);
  }
      ...
      throws SQLException
  {
    ...
    try
    {
      ...
      ExecuteUpdateResult execWriteRequestResult = drm
          .loadBalanceStatementExecuteUpdate((AbstractWriteRequest) request);
      drm.updateAndNotifyExecWriteRequest((AbstractWriteRequest) request,
          execWriteRequestResult.getUpdateCount());
    ...
    {
      // Add to failed list, the scheduler has already been notified by either
