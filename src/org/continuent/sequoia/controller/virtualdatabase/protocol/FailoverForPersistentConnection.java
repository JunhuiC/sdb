...
/**
 * This class defines a FailoverForPersistentConnection to notify that a client
 * has transparently failed over for the given persistent connection.
 * 
 * @author <a href="mailto:emmanuel.cecchet@continuent.com">Emmanuel Cecchet</a>
 * @version 1.0
 */
public class FailoverForPersistentConnection
    extends DistributedVirtualDatabaseMessage
{
  private static final long serialVersionUID = 7480377277487864642L;
  private long              connectionId;

  /**
   * Creates a new <code>FailoverForPersistentConnection</code> object
   * 
   * @param connectionId the persistent connection identifier
   */
  public FailoverForPersistentConnection(long connectionId)
  {
    this.connectionId = connectionId;
  }

  /**
   * Returns the persistent connection id.
   * 
  ...
  {
    long controllerId = connectionId
        & DistributedRequestManager.CONTROLLER_ID_BIT_MASK;
        
    Long cid = new Long(connectionId);
   
    dvdb.notifyPersistentConnectionFailover(new Long(controllerId), cid);
    return null;
  }
