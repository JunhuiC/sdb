...
/**
 * This class defines a distributed call to CallableStatement.execute()
 * 
 * @author <a href="mailto:emmanuel.cecchet@continuent.com">Emmanuel Cecchet
 *         </a>
 * @version 1.0
 */
public class DistributedCallableStatementExecute extends DistributedRequest
{
  private static final long serialVersionUID = 8634424524848530342L;

  /**
   * Creates a new <code>DistributedCallableStatementExecute</code> object to
   * execute a stored procedure on multiple controllers.
   * 
   * @param proc the stored procedure to execute
   */
  public DistributedCallableStatementExecute(StoredProcedure proc)
  {
    super(proc);
  }
      ...
      throws SQLException
  {
    ...
    try
    {
      ...
      drm.scheduleStoredProcedure(proc);
      ...
      result = new StoredProcedureCallResult(proc, drm
          .loadBalanceCallableStatementExecute(proc));
