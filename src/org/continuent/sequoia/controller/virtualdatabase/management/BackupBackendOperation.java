...
/**
 * This class defines a BackupBackendOperation
 * 
 * @author <a href="mailto:emmanuel.cecchet@continuent.com">Emmanuel Cecchet</a>
 * @version 1.0
 */
public class BackupBackendOperation extends AbstractAdminOperation
{
  private String backendName;
  private String dumpName;

  /**
   * Creates a new <code>BackupBackendOperation</code> object
   * 
   * @param backendName name of the backend being backuped
   * @param dumpName name of the dump
   */
  public BackupBackendOperation(String backendName, String dumpName)
  {
  ...
  public void cancel() throws NotImplementedException
  {
    throw new NotImplementedException(
        "Cancel operation is not implemented for BackupOperation");
  }
  ...
  {
    return "Backup " + dumpName + " for backend " + backendName;
  }
