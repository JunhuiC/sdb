...
/**
 * This class defines an EnableBackendOperation corresponding to a backend
 * enable command.
 * 
 * @author <a href="mailto:emmanuel.cecchet@continuent.com">Emmanuel Cecchet</a>
 * @version 1.0
 */
public class EnableBackendOperation extends AbstractAdminOperation
{
  private String backendName;

  /**
   * Creates a new <code>EnableBackendOperation</code> object
   * 
   * @param backendName name of the backend enabled
   */
  public EnableBackendOperation(String backendName)
  {
    this.backendName = backendName;
    operationStatus = STATUS_EXECUTING;
  }
  ...
  public void cancel() throws NotImplementedException
  {
    throw new NotImplementedException(
        "Cancel operation is not implemented for EnableOperation");
  }
  ...
  {
    return "Enabling backend " + backendName;
  }
