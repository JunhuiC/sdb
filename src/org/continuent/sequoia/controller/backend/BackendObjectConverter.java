...
/**
 * This class defines a BackendObjectConverter
 * 
 * @author <a href="mailto:emmanuel.cecchet@emicnetworks.com">Emmanuel Cecchet</a>
 * @version 1.0
 */
public interface BackendObjectConverter
{
  /**
   * Return object number i of the current ResultSet row and convert it as
   * needed by the backend specific implementation.
   * 
   * @param dbResultSet the database backend ResultSet
   * @param i the ResultSet column number (starting at 1, SQL counting style)
   * @param f column metadata
   * @return the converted object
   * @throws SQLException if an error occurs
   */
  Object convertResultSetObject(ResultSet dbResultSet, int i, Field f)
      throws SQLException;
