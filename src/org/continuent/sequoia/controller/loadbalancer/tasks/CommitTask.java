...
public class CommitTask extends AbstractTask
{
   ...
   */
  public CommitTask(int nbToComplete, int totalNb, TransactionMetaData tm)
      ...
      throws SQLException
  {
    ...
    { // Bad connection
      ...
      String msg = "Failed to commit transaction " + tm.getTransactionId()
  ...
  {
    if ((other == null) || !(other instanceof CommitTask))
      return false;

    CommitTask commit = (CommitTask) other;
    return this.getTransactionId() == commit.getTransactionId();
  }
  ...
  {
    return "CommitTask (" + tm.getTransactionId() + ")";
  }
}