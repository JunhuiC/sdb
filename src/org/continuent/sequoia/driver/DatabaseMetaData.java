...
/**
 * DatabaseMetaData retrieves most of the values from the Sequoia controller. If
...
public class DatabaseMetaData implements java.sql.DatabaseMetaData
{
   ...
   * the backend drivers, default is to return "Sequoia Controller".
   * 
   ...
   * 
   * @return the Sequoia driver version
   * @exception SQLException if an error occurs
   */
