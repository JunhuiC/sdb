...
public class Connect extends ConsoleCommand
{
  ...
  {
    return ConsoleTranslate.get("controller.command.connect.params", ConsoleLauncher.PRODUCT_NAME); //$NON-NLS-1$
  }
  ...
  {
    return ConsoleTranslate.get("controller.command.connect.description", ConsoleLauncher.PRODUCT_NAME); //$NON-NLS-1$
  }
