...
public class Begin extends ConsoleCommand
{
  ...
  public void parse(String commandText) throws IOException, ConsoleException
  {
    ...
    try
    {
      ...
      console.printInfo(ConsoleTranslate.get("sql.display.transaction.started")); //$NON-NLS-1$
    }
    catch (Exception e)
    {
  ...
  {
    return ConsoleTranslate.get("sql.command.begin"); //$NON-NLS-1$
  }
}