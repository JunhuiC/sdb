...
/**
 * This class defines a ShowActivityStatus command.
 * 
 * @author <a href="mailto:stephane.giron@continuent.com">Stephane Giron </a>
 * @version 1.0
 */
public class ShowActivityStatus extends AbstractAdminCommand
{

  /**
   * Creates a new <code>ShowActivityStatus</code> object
   * 
   * @param module the commands is attached to
   */
  public ShowActivityStatus(VirtualDatabaseAdmin module)
  {
    super(module);
  }
  ...
  public void parse(String commandText) throws Exception
  {
    ...
    console.println(db.getActivityStatus());
  }
  ...
  {
    return "show activity status"; //$NON-NLS-1$
  }
  ...
  {
    return ConsoleTranslate.get("admin.command.show.activity.status.description"); //$NON-NLS-1$
  }
