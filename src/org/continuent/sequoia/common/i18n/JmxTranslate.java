...
/**
 * Class to translate the different messages of Sequoia JMX MBeans descriptions.
 * 
...
public final class JmxTranslate
{
  /**
   * JMX message description is stored in a different file
   */
  private static final String   BUNDLE_NAME     = "org.continuent.sequoia.common.i18n.mbean-messages"; //$NON-NLS-1$
