...
/**
 * Class to translate the different messages of Sequoia CLI Console.
 * 
 * @author <a href="mailto:Nicolas.Modrzyk@inria.fr">Nicolas Modrzyk </a>
 * @version 1.0
 */
public final class ConsoleTranslate
{
  /**
   * console message description is stored in a different file
   */
  private static final String         BUNDLE_NAME     = "org.continuent.sequoia.common.i18n.console-messages"; //$NON-NLS-1$

  /**
   * Translation RESOURCE_BUNDLE for Sequoia messages
   */
  ...
  {
    return get(key, new Object[]{Boolean.toString(parameter)});
  }
