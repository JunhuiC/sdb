...
public class LoggingOutputStream extends OutputStream
{
  ...
  public void flush()
  {
    ...
    {
      if (((char) buf[0]) == LINE_SEPARATOR.charAt(0) && ((count == 1) || // <-
                                                                                                                                 // Unix
                                                                                                                                 // &
                                                                                                                                 // Mac,
                                                                                                                                 // ->
    ...
    int line = -1;
    while((line = bytes.indexOf(LINE_SEPARATOR))!=-1)
    {
        bytes = bytes.substring(0, line) + bytes.substring(line+LINE_SEPARATOR.length());
    }
    // END ADDED 
